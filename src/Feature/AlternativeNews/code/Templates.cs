namespace Sitecore.Feature.AlternativeNews
{
    using Sitecore.Data;
    ...
    public struct Templates
    {
        ...
        public struct NewsfeedArticle
        {
            public const string ID = "{C2BBFE65-AF2F-4573-BAF0-498F1DBC5923}";

            public struct Fields
            {
                public static readonly ID Title = new ID("{572B27EA-02F7-4089-8BB6-44A10670DAD3}");
                public const string Title_FieldName = "Title";

                public static readonly ID Content = new ID("{3BEB57F7-CEEB-488B-AA1C-CF7F5BF17489}");
